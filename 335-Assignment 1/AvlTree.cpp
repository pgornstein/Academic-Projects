#include "AvlTree.h"
    ...
    /**
     * Internal method that eturns item if found in the tree
     */
    template<typename Comparable>
     ...
     */
    template<typename Comparable> 
    Comparable  AvlTree<Comparable>::find(Comparable & x, AvlNode *t)
    {
        if( x < t->element )
...
*****************************************************/
    ...
    /**
     *Internal method that returns number of nodes in the tree. 
     */
    template<typename Comparable>
    int AvlTree<Comparable>::nodes(AvlNode *t) {
      int num = 1; 
    ...
    /**
     *Internal method that returns the internal path length of the tree. 
     */
    template<typename Comparable>
    int AvlTree<Comparable>::internalPathLength(AvlNode *t, int depth)
    {
      int num = depth; 
